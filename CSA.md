...
1. ## Service  
    ...
    1.2 <span class="header_3">Service Level.</span> If there is an <span class="orderform_link">SLA</span> and the Cloud Service does not meet the <span class="orderform_link">SLA</span>, <span class="keyterms_link">Provider</span> will provide the remedies outlined in the <span class="orderform_link">SLA</span> and will not be responsible for any other remedies. Any credits earned under the <span class="orderform_link">SLA</span> will only apply to future invoices and expire if the Agreement ends. In any event, if the Cloud Service is temporarily unavailable for scheduled maintenance, for unscheduled emergency maintenance, or because of other causes beyond <span class="keyterms_link">Provider's</span> reasonable control, no <span class="orderform_link">SLA</span> remedies will accrue. <span class="keyterms_link">Provider</span> will try to inform <span class="keyterms_link">Customer</span> before scheduled service disruptions through the Cloud Service or by email.
