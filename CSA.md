...
1. ## Service  
    ...
    1.1 <span class="header_3">Access and Use.</span>  During the <span class="orderform_link">Subscription Period</span> and subject to the <span class="orderform_link">Use Limitations</span>, <span class="keyterms_link">Customer</span> may (a) access and use the Cloud Service; and (b) copy and use the included Software and Documentation only as needed to access and use the Cloud Service, in each case, for its internal business purposes and only if <span class="keyterms_link">Customer</span> complies with the terms of this Agreement.
